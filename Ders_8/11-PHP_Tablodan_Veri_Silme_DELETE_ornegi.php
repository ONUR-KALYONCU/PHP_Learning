...
<title>PHP ile MySQL Veritabanı Tablodan Veri Silme örneği</title>
<?php echo '
...
$sorgu = mysqli_query($db,"DELETE FROM uyeler WHERE `uye_id`='3'");


echo 'Öğrenci Veritabanında "ÜYELER" Tablosundan (uye_id="3") olan Veri SİLİNDİ.';
