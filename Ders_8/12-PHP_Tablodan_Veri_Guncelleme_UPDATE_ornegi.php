...
<title>PHP ile MySQL Veritabanı Tablosundaki Veriyi Güncelleme örneği</title>
<?php echo '
...
// ----------------------------------------------------------------------------------------------------------------------------
?><?php 
$sorgu = mysqli_query($db,"UPDATE `mezun_ogrenci` SET ogrenci_adi='Ahmet' WHERE ogrenci_id='2'");


echo 'Ogrenci Veritabanında "Mezun Öğrenci" Tablosundan (uye_id="2") olan Veriyi GÜNCELLE.';
...
<div class="container">
    ...
    <tbody>
<?php 
$sorgu = mysqli_query($db,"SELECT * FROM `mezun_ogrenci` WHERE ogrenci_adi LIKE '%M%' ORDER BY `ogrenci_soyadi` DESC");
