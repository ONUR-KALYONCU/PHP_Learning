...
<title>PHP ile MySQL Veritabanı Tablodan Veri Gösterme BETWEEB örneği</title>
<?php echo '
...
<div class="container">
    ...
    <tbody>
<?php 
$sorgu = mysqli_query($db,"SELECT * FROM mezun_ogrenci WHERE aldigi_not_vize BETWEEN 50 AND 70");
...
<?php 
ECHO "TABLOSUZ SORGULAMA GÖRÜNÜMÜ<BR><BR>";
