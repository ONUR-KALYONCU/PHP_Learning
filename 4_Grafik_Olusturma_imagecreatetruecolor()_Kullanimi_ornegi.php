...
<title>Grafik Oluşturmada (imagecreatetruecolor) Kullanımı - Örneği</title>
</head>
...
$image = imagecreatetruecolor(500, 300);	// görüntünün veya boş görüntünün boyutunu belirleyin.
