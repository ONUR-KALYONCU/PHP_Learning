...
<title>Mevcut Görsel ve Yazı Tipini Kullanarak Değişiklik yapma Kullanımı - GİF Örneği</title>
</head>
...
$resim=imagecreatefromgif('https://i.pinimg.com/originals/3b/7c/07/3b7c070686c4a76b48344ef557dca51b.gif'); // PNG URL'sinden bir resim yükleyin
...
imagecolorallocate($resim, 0, 0, 255), 'verdana.ttf', 'Salıncak');

//Yapılan değişiklikleri PNG formatında resim dosyası haline getirelim
imagegif($resim,"salincak_yeni.gif");
imagedestroy($resim);
?>
