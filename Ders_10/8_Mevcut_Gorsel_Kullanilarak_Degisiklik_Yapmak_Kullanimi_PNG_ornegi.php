...
$resim=imagecreatefrompng('logo.png'); // PNG URL'sinden bir resim yükleyin
...
imagecolorallocate($resim, 0, 0, 255), 'verdana.ttf', 'ismail Keklik');

//Yapılan değişiklikleri PNG formatında resim dosyası haline getirelim
imagepng($resim,"logo_yeni.png");
imagedestroy($resim);
?>
