...
$resim=imagecreatefromjpeg('gorsel.jpg'); // PNG URL'sinden bir resim yükleyin
...
imagecolorallocate($resim, 0, 0, 255), 'verdana.ttf', 'Merhaba');

//Yapılan değişiklikleri PNG formatında resim dosyası haline getirelim
imagejpeg($resim,"gorsel_yeni.jpg");
imagedestroy($resim);
?>
